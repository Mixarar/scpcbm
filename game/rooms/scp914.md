...
**SCP-914**, also known as "**The Clockworks**", is an SCP object,It is currently one of the few SCPs in the game that can actually aid the player.![914.png](/images/rooms/914.png)
## Description
...
![914panel.png](/images/rooms/914panel.png =180x){.align-left}**Rough** - *Dismantles or destroys the item*
